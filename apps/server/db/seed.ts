  ...
  try {
    ...
    const instructors = [
      {
        ...
        avatarUrl:
          "https://ui-avatars.com/api/?name=CD&background=0ea5e9&color=fff&size=128",
      },
      {
        id: createId(),
        ...
        avatarUrl:
          "https://ui-avatars.com/api/?name=KT&background=22c55e&color=fff&size=128",
      },
      {
        id: createId(),
        ...
        avatarUrl:
          "https://ui-avatars.com/api/?name=LN&background=f59e0b&color=fff&size=128",
      },
      {
        id: createId(),
        ...
        avatarUrl:
          "https://ui-avatars.com/api/?name=PJ&background=8b5cf6&color=fff&size=128",
      },
    ];
    ...
    const coursesData = [
      ...
      },
      {
        ...
        description:
          "Master the art of error tracking and debugging in complex applications.",
      ...
      },
      {
        ...
        description:
          "Learn how to identify and resolve performance bottlenecks in your applications.",
      ...
      },
      {
        ...
        description:
          "Understand and implement distributed tracing in microservice architectures.",
    ...
    for (const course of coursesData) {
      ...
      if (course.slug === "performance-optimization-techniques") {
        console.log(
          `Creating detailed performance lessons for ${course.title}...`
        );
        ...
        const performanceLessons = [
          {
            ...
            description:
              "Understanding performance metrics and analysis techniques.",
            type: "text" as const,
          ...
          },
          {
            ...
            description:
              "Configure comprehensive performance monitoring for your applications.",
            type: "text" as const,
          ...
          },
          {
            ...
            description:
              "Optimize client-side performance for better user experience.",
            type: "text" as const,
          ...
          },
          {
            ...
            description:
              "Master various caching techniques to improve application performance.",
            type: "text" as const,
        ...
        for (let i = 1; i <= lessonCount; i++) {
          await db
            ...
            .values({
              ...
              content:
                i % 2 === 1
                  ? `# Lesson ${i} Content\n\nThis is the content for lesson ${i}...`
                  : null,
              videoUrl:
                i % 2 === 0
                  ? `https://example.com/videos/course-${course.id}-lesson-${i}`
                  : null,
